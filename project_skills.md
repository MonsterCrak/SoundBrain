...
|-------|---------|-----------|
| `banana` | AI Image Generation Creative Director | generate, edit, chat, inspire, batch commands |
| `obsidian-markdown` | Obsidian Flavored Markdown documentation | wikilinks, callouts, embeds, properties |
| `mobile-design` | Mobile-first design thinking | iOS/Android, React Native, Flutter, touch UX |
| `senior-architect` | Software architecture & system design | patterns, tech decisions, diagrams |
...
```bash
# Image generation with prompt optimization
/banana generate a cinematic portrait of a musician

# Edit existing image
/banana edit ./photo.jpg enhance lighting

# Multi-turn creative session
/banana chat

# Prompt inspiration
/banana inspire fashion-editorial
```
...
### Scripts
- `mobile_audit.py` - Mobile UX audit
- `architecture_diagram_generator.py` - System diagrams
- `dependency_analyzer.py` - Dependency analysis
- `search.py` - UI/UX design search
- `prompt_optimizer.py` - LLM optimization
- `rag_evaluator.py` - RAG evaluation
- `agent_orchestrator.py` - Agent management
- `batch.py`, `cost_tracker.py`, `generate.py`, `edit.py` - Banana image tools
